...
<div id="view-product-list" class="view-product-list">
                            <h1 class="page-heading">
                                ...
                                <span class="page-heading-title" itemprop="name"><?php $row = mysqli_fetch_array($data["TenLoaiCode"]);
                                echo $row["theloai"] ?></span>
                            </h1>
                            ...
                            <!-- PRODUCT LIST -->
                                ...
                                <?php 
                                    while($row = mysqli_fetch_array($data["CodeTheoNgonNgu"])){
                                        ?>
