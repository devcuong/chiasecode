...
<div class="block left-module box-border2">
    <div class="pro-left">
        <a href="https://sharecode.vn/thong-tin-ca-nhan.htm">
            <img src="https://sharecode.vn/assets/images/avanta2.png" id="mainbody_contentbody_ucProfile_Avanta" class="prof_img" alt="sen đỏ TV - sen đỏ TV" width="90" height="90" title="sen đỏ TV - sen đỏ TV">
        </a>
    </div>
    <div class="pro-right">
    ...
    <div class="pro-link clear pro-link-first">
        ...
        <a href="https://sharecode.vn/thanh-vien/sen-do-tv-298614.htm" id="mainbody_contentbody_ucProfile_LinkPageUser" class="aorange"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;Trang cá nhân</a>
    </div>
     <div class="pro-link">
    ...
    <ul class="pro-list">
        <li id="mnCodeUpload">
            <a href="code-upload-cua-toi">Code tải lên (<strong id="upload-count">0</strong>)</a>
        </li>
        <li id="mnCodeSave">
            <a href="code-da-luu">Code đã lưu (<strong id="save-count">0</strong>)</a>
        </li>
         <li id="mnCodeDown">
            <a href="code-download">Code đã mua (<strong id="buy-count">0</strong>)</a>
        </li>
        <li id="mnCodeSell">
            <a href="doanh-thu-ban-code">Doanh thu bán code</a>
        </li>
       
        <li id="mnAddMoney">
            <a href="lich-su-giao-dich">Lịch sử nạp tiền</a>
        </li>
        <li id="mnGetMoney" class="pro-select">
