...
class ThanhVienUpload extends Controller
{
    ...
    public function CropFile()
    {
        if (isset($_POST["image"])) {
            ...
            $imageFile = '<img src="' . $tempData . '" class="img-thumbnail" id="img-dai-dien" name="img-dai-dien" />';
            $imageFile = $imageFile . '<input type="hidden" id="img-dai-dien-hidden" name="img-dai-dien-hidden" value="' . $tempData . '">';
